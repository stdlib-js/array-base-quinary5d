...
```javascript
quinary5d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-quinary5d@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-quinary5d@v0.2.3-umd/browser.js"></script>
```
