...
```javascript
import quinary5d from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-quinary5d@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/array-base-quinary5d/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/array-base-quinary5d/actions/workflows/test.yml?query=branch:v0.1.0
